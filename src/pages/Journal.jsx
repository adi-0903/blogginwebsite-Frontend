...
const Journal = () => {
    ...
    const fetchPosts = async () => {
        try {
            setLoading(true)
            setError('')
            const response = await api.blog.getPosts({ status: 'published', post_type: 'journal' })
    ...
    return (
        <div className="journal-page">
            ...
            >
                ...
                <h1>Your Journal</h1>
                <p>Your personal stories and reflections</p>
                    ...
                    >
                        {filteredPosts.length === 0 ? (
                            ...
                            filteredPosts.map((post, i) => (
                                <Link key={post.id} to={`/journal/${post.slug}`} style={{ textDecoration: 'none', color: 'inherit' }}>
                                    <motion.article
            ...
            <section className="featured-section">
                <div className="section-header">
                    ...
                    <div className="header-line" />
                    <Link to="/journal/all" className="view-all-btn">
                        View All
                        <ArrowRight />
                    </Link>
                </div>
